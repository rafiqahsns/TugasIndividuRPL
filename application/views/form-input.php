...
<img style="vertical-align:middle" src="<?php echo base_url("assets/img/logo2.png")?>"> 
  ...
  <div class="header-right">
    ...
    <a class="active" href="<?php echo site_url('welcome/form_input') ?>">Add your favorite book</a>
...
<h1>Add Your Favorite Book</h1>
	<div id="body">
        <form action="<?php echo site_url('welcome/insert') ?>" method="POST">
            ...
            Year Published <br>
            <input type="number" name="yearpublished" min="1700" max="2019"  pattern=".{4}"/><br>
            Rating (1-5) <br>
            <input type="number" name="rating" min="1" max="5" maxlength="1"/><br>
